...
// Se agregan opciones una por una para no borrar el placeholder "Seleccionar..."
...
if (btnGuardar) {
  btnGuardar.addEventListener('click', function () {
    ...
    const pedidoNuevo = {
      ...
      platillo: opcion.textContent.trim(),
      nombre: nombre,
      direccion: direccion,
...
function dibujarMapa(latitud, longitud) {
  ...
  // Se reutiliza el mismo marcador para no acumular uno por consulta.
  if (marcador) {
